    ...
    <div style="overflow-x:auto;">
        <table class="data-table">
            ...
            <thead>
                <tr>
                    <th>No</th>
                    <th><a href="{{ sortUrl('name', $sortColumn, $sortDirection) }}" style="color: inherit; text-decoration: none;">Nama Pegawai {!! sortIcon('name', $sortColumn, $sortDirection) !!}</a></th>
                    <th><a href="{{ sortUrl('position', $sortColumn, $sortDirection) }}" style="color: inherit; text-decoration: none;">Posisi {!! sortIcon('position', $sortColumn, $sortDirection) !!}</a></th>
                    <th><a href="{{ sortUrl('employee_type', $sortColumn, $sortDirection) }}" style="color: inherit; text-decoration: none;">Tipe {!! sortIcon('employee_type', $sortColumn, $sortDirection) !!}</a></th>
                    <th><a href="{{ sortUrl('salary_rate', $sortColumn, $sortDirection) }}" style="color: inherit; text-decoration: none;">Rate / Hari {!! sortIcon('salary_rate', $sortColumn, $sortDirection) !!}</a></th>
                    <th><a href="{{ sortUrl('is_active', $sortColumn, $sortDirection) }}" style="color: inherit; text-decoration: none;">Status {!! sortIcon('is_active', $sortColumn, $sortDirection) !!}</a></th>
                    <th>Aksi</th>
                </tr>
            </thead>
            <tbody>
