...
<div class="cards-grid">
    ...
    <div class="content-card">
        <div class="card-header">
            <h3><i class="fas fa-users" style="color:var(--accent); margin-right:6px;"></i> Daftar Pegawai</h3>
        ...
        <div class="card-body">
            ...
            <div class="payroll-item">
                ...
                <div>
                    <div class="pi-amount" style="font-size:0.85rem; font-weight:600; color:var(--text-muted);">
                        {{ ucfirst($pegawai->employee_type) }}
                    </div>
                    <div style="font-size:0.72rem; color:var(--text-muted); text-align:right;">
                        Rate: Rp {{ number_format($pegawai->salary_rate, 0, ',', '.') }}
                    </div>
                </div>
            </div>
            @empty
        ...
        <div style="padding: 0.9rem 1.25rem; border-top: 1px solid var(--border); display:flex; align-items:center; justify-content:space-between;">
            <span style="font-size:0.8rem; color:var(--text-muted);">Total pegawai aktif</span>
