...
<div class="pay-layout">
    ...
    <div class="pay-card">
        ...
        <div class="pay-card-body">
            <form action="{{ route('kasir.pembayaran.store') }}" method="POST" id="formBayar">
            @csrf
            ...
            <div style="display:flex; gap:10px; margin-top:0.5rem;">
                ...
                <a href="{{ route('kasir.dashboard') }}" class="btn btn-outline"><i class="fas fa-times"></i> Batal</a>
            </div>
                ...
                @forelse($selected->payments as $p)
                    <div class="payment-item">
                        <div class="pi-left">
                            ...
                            <div class="pi-sub">{{ $p->tanggal_bayar->format('d M Y') }}{{ $p->catatan ? ' · '.$p->catatan : '' }}</div>
                        </div>
...
@push('scripts')
<script>
const ajaxBase = "{{ route('kasir.pembayaran.order', '__ID__') }}".replace('__ID__', '');
                ...
                data.payments.forEach(p => {
                    ...
                    <div class="payment-item">
                        <div class="pi-left">
                            ...
                            <div class="pi-sub">${p.tanggal}</div>
                        </div>
