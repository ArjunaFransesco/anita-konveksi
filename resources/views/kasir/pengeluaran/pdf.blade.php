...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        tbody td { padding: 6px 10px; border-bottom: 1px solid #ccc; font-size: 10px; }
        ...
        .tipe-bahan_baku  { background: #eee; color: #333; }
        .tipe-gaji        { background: #eee; color: #333; }
        .tipe-operasional { background: #eee; color: #333; }
        .tipe-listrik_air { background: #eee; color: #333; }
        .tipe-lain_lain   { background: #eee; color: #333; }

        tfoot tr { background: #333; color: #fff; }
        tfoot td { padding: 8px 10px; font-size: 11px; font-weight: 700; }

        .footer { font-size: 9px; color: #555; text-align: center; margin-top: 10px; border-top: 1px solid #ccc; padding-top: 8px; }
    </style>
</head>
<body>
    <div class="header">
