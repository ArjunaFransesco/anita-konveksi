...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        tbody td { padding: 5px 8px; border-bottom: 1px solid #ccc; font-size: 9px; }
        ...
        .badge-lunas  { background: #eee; color: #333; }
        .badge-belum  { background: #ddd; color: #333; }
        .footer { font-size: 8px; color: #555; text-align: center; margin-top: 12px; border-top: 1px solid #ccc; padding-top: 6px; }
    </style>
</head>
<body>
    <div class="header">
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align:right; color:#333; font-weight:600;">
