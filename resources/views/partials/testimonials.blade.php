...
<section class="testimonials-section">
    <div class="container">
        <h2 class="section-title scroll-reveal">Apa Kata Pelanggan Kami?</h2>
        <div class="testimonials-grid">
            ...
            <div class="testimonial-card scroll-reveal from-left delay-{{ $loop->iteration }}">
        ...
        <div class="testimonial-footer scroll-reveal">
